...
namespace DG.Tweening.Core
{
    ...
    {
        // Editor-friendly access to active tweens array
        public static Tween[] GetActiveTweens() { return _activeTweens; } // Required by Editor

        // Editor-friendly properties for internal fields
        public static bool IsDebugBuild { get { return isDebugBuild; } } // Required by Editor
        public static int MaxTweeners { get { return maxTweeners; } } // Required by Editor
        public static int MaxSequences { get { return maxSequences; } } // Required by Editor
        public static int TotActiveTweens { get { return totActiveTweens; } } // Required by Editor
        public static int TotActiveDefaultTweens { get { return totActiveDefaultTweens; } } // Required by Editor
        public static int TotActiveLateTweens { get { return totActiveLateTweens; } } // Required by Editor
        public static int TotActiveFixedTweens { get { return totActiveFixedTweens; } } // Required by Editor
        public static int TotActiveManualTweens { get { return totActiveManualTweens; } } // Required by Editor
        public static int TotActiveTweeners { get { return totActiveTweeners; } } // Required by Editor
        public static int TotActiveSequences { get { return totActiveSequences; } } // Required by Editor
        public static int TotPooledTweeners { get { return totPooledTweeners; } } // Required by Editor
        public static int TotPooledSequences { get { return totPooledSequences; } } // Required by Editor

        // Editor-friendly wrapper methods for internal Play/Pause operations // Required by Editor
        public static void Play(Tween t) { Play_Internal(t); }
        public static void Pause(Tween t) { Pause_Internal(t); }
        public static int TotalPlayingTweens() { return TotalPlayingTweens_Internal(); }
        public static int TotalPooledTweens() { return TotalPooledTweens_Internal(); }
...
//                        if (isUpdateLoop) t.active = false; // Just mark it for killing, so the update loop will take care of it
                    ...
                    case OperationType.Pause:
                        if (Pause_Internal(t)) totInvolved++;
                        break;
                    case OperationType.Play:
                        if (Play_Internal(t)) totInvolved++;
                        break;
...
//            int toCompletedLoops = (int)((decimal)to / (decimal)t.duration); // Takes care of floating points imprecision (nahh doesn't work correctly either)
        ...
        internal static bool Pause_Internal(Tween t)
        {
            if (t.isPlaying) {
                t.isPlaying = false;
        ...
        internal static bool Play_Internal(Tween t)
        {
        ...
        {
            if (t.isPlaying) return Pause_Internal(t);
            return Play_Internal(t);
        }
        ...
        internal static int TotalPooledTweens_Internal()
        {
            return totPooledTweeners + totPooledSequences;
        }

        internal static int TotalPlayingTweens_Internal()
        {
        ...
        static void EvaluateTweenLink(Tween t)
        {
            ...
            if (tLink.target == null) {
                ...
                case LinkBehaviour.RewindOnDisable:
                    ...
                    break;
                case LinkBehaviour.PauseOnDisable:
                    if (justDisabled && t.isPlaying) Pause_Internal(t);
                    break;
                case LinkBehaviour.PauseOnDisablePlayOnEnable:
                    if (justDisabled) Pause_Internal(t);
                    else if (justEnabled) Play_Internal(t);
                    break;
                case LinkBehaviour.PauseOnDisableRestartOnEnable:
                    if (justDisabled) Pause_Internal(t);
                    ...
                    break;
                case LinkBehaviour.PlayOnEnable:
                    if (justEnabled) Play_Internal(t);
                    break;
                case LinkBehaviour.RestartOnEnable:
