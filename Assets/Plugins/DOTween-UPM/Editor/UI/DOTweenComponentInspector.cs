...
namespace DG.DOTweenEditor.UI
{
    ...
    public class DOTweenComponentInspector : Editor
    {
        ...
        {
            _headerImg = AssetDatabase.LoadAssetAtPath(EditorUtils.adbPrefix + EditorUtils.editorADBDir + "Imgs/DOTweenIcon.png", typeof(Texture2D)) as Texture2D;
        ...
        void DrawTweensButtons(int totPlayingTweens, int totPausedTweens)
        {
            ...
            if (_settings.showPlayingTweens) {
                foreach (Tween t in TweenManager.GetActiveTweens()) {
