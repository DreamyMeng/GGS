...
//        }
        ...
        static void StoreDOTweenDirsAndFilePaths()
        {
            ...
            if (isPackage) {
                adbPrefix = "Packages/";
                _dotweenDir += "Runtime" + pathSeparator;
            } else {
                adbPrefix = "Assets/";
            }
            ...
            // For UPM packages, Modules is a sibling to Runtime, not a child
            if (isPackage) {
                _dotweenModulesDir = dotweenParentDir + "Modules" + pathSeparator;
                _dotweenModulesDir = _dotweenModulesDir.Replace(pathSlashToReplace, pathSlash);
            } else {
                _dotweenModulesDir = _dotweenDir + "Modules" + pathSlash;
            }
            // Don't error if Modules directory doesn't exist in UPM package (it's optional)
            ...
            _dotweenProEditorDir = _dotweenProDir + "Editor" + pathSeparator;
            _dotweenTimelineDir = _dotweenTimelineDir.Replace(pathSlashToReplace, pathSlash);
            _dotweenTimelineScriptsDir = _dotweenTimelineDir + "Scripts" + pathSeparator;
            _dotweenTimelineEditorScriptsDir = _dotweenTimelineScriptsDir + "Editor" + pathSeparator;
